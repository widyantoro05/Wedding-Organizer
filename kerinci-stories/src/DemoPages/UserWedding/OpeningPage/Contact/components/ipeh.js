...
import avatar4 from "../../../../../assets/utils/images/avatars/ipeh.PNG";
import photo from "../../../../../assets/utils/images/photo2.jpg";

import { Card } from "reactstrap";

class Ipeh extends Component {
  render() {
    return (
      <Fragment>
        <CSSTransitionGroup
        ...
        >
          <Card className="mb-3 profile-block">
            <div className="dropdown-menu-header">
              <img src={photo} alt="" className="profile-blur opacity-9" />
              <div className="menu-header-content">
                ...
                <h5 className="menu-header-title">Ipeh</h5>
